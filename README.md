...
I'm **Abhay Chauhan**, a final-year BCA (Artificial Intelligence) student at Invertis University, building production-grade AI and full-stack applications rather than toy projects — each one designed, built, and deployed end-to-end.

🔹 Building AI-powered applications and automation systems

🔹 Working with LLMs, RAG pipelines, and intelligent workflows

🔹 Full-stack development with FastAPI / Spring Boot / React

🔹 Shipping deployed, resume-worthy projects — not tutorials

🔹 Preparing for software developer / backend / AI-ML placement roles

🔹 Open to collaborating on meaningful AI and full-stack projects

### 🎯 Current Focus

- 🤖 Applied AI/ML & LLM integration (Claude, OpenAI)
- ⚡ FastAPI & Spring Boot backend systems
- 🌐 Full-stack apps with React + MongoDB/MySQL
